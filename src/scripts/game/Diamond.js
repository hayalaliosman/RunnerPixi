...
export class Diamond{
    ...
    createBody(){
        this.body = Matter.Bodies.rectangle(this.sprite.width / 2 + this.sprite.x, this.sprite.height / 2 + this.sprite.y, this.sprite.width, this.sprite.height, { friction: 0, isStatic: true});
